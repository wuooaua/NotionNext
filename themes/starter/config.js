...
const CONFIG = {
  ...
  STARTER_HERO_TITLE_1: '做彼此道路上的朋友', // 英雄区文字
  STARTER_HERO_TITLE_2: '是进亦忧，退亦忧。然则何时而乐耶？', // 英雄区文字
  ...
  STARTER_FEATURE_TITLE: '定制', // 特性
  STARTER_FEATURE_TEXT_1: '特定角色生成', // 特性
  STARTER_FEATURE_TEXT_2:
    '选择你的角色、特定场景、特定表情、特定动作、特定服装', // 特性

  STARTER_FEATURE_1_TITLE_1: '角色', // 特性1
  STARTER_FEATURE_1_TEXT_1: '快速生成所需角色图片', // 特性1
  STARTER_FEATURE_1_BUTTON_TEXT: '了解更多', // 特性1
  STARTER_FEATURE_1_BUTTON_URL: 'https://github.com/tangly1024/NotionNext', // 特性1

  STARTER_FEATURE_2_TITLE_1: '角色风格', // 特性2
  STARTER_FEATURE_2_TEXT_1: '定制角色画风，适配不同使用场景', // 特性2
  STARTER_FEATURE_2_BUTTON_TEXT: '了解更多', // 特性2
  STARTER_FEATURE_2_BUTTON_URL:
    'https://docs.tangly1024.com/article/notion-next-themes', // 特性2

  STARTER_FEATURE_3_TITLE_1: '角色动作', // 特性3
  STARTER_FEATURE_3_TEXT_1: '', // 特性3
  STARTER_FEATURE_3_BUTTON_TEXT: '了解更多', // 特性3
  STARTER_FEATURE_3_BUTTON_URL: 'https://docs.tangly1024.com/article/next-js', // 特性3

  STARTER_FEATURE_4_TITLE_1: '场景', // 特性4
  ...
  STARTER_ABOUT_TITLE: 'AI定制角色生成', // ABOUT区块标题
  STARTER_ABOUT_TEXT:
    '为想要，最低成本、最快速地搭建自己的网站，帮助您将自己的产品与故事高效地传达给世界。 <br /> <br /> 功能强大的Notion笔记，简单快速的Vercel托管平台，组成一个简单的网站',
